    ...
    <>
      <nav className="navbar z-50">
        <Link to="/" className="flex-none w-10">
          <img src={theme == "light" ? logo : lightLogo} alt="logo" />
        </Link>
        ...
        >
          <input
            type="text"
            placeholder="Search"
            className="w-full md:w-auto md:pl-12 bg-grey p-4 pl-6 pr-[12%] md:pr-6 rounded-full placeholder:text-dark-grey"
        ...
        <div className="flex items-center gap-3 md:gap-6 ml-auto">
          <button
            className="md:hidden bg-grey text-2xl w-12 h-12 rounded-full flex items-center justify-center"
            onClick={() => setSearchBoxVisiblity((curr) => !curr)}
          >
